...
void i2c_escreve(unsigned char dado)
{
	i2c_Start();
        i2c_Address(0x00,0x01);
        i2c_Write(dado);
        i2c_Stop();

}

unsigned char i2c_le(unsigned char funcao)
{
	...
	i2c_Start();
        ...
        i2c_Write(funcao);
        i2c_Start();
        i2c_Address(0x00,0x00);
        dado_recebido=i2c_Read(0);
